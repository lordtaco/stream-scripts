...
# Replace this with the MAC address of your Pixoo Max.
pixoo_device = '00:00:00:00:00:00'
# Replace this with a path to save the avatar image.
image_path = r"C:\Users\example\latest-avatar.png"
...
if __name__ == '__main__':
    pixoo = PixooMax(pixoo_device)
    pixoo.connect()
    
    # pixoo.set_system_brightness(100)
    
    if args.url:
      urllib.request.urlretrieve(args.url, image_path)
      sleep(1)
      pixoo.draw_pic(image_path)
    else:
      sleep(1)
      pixoo.set_box_mode(0, 0)
